...
export const PRODUCTS: Product[] = [
...

  {
    ...
    coatingSummary: 'None',
    verification: { tier: 4 as VerificationTier, claimType: 'inherently_pfas_free', scopeText: 'All Vitamix blenders', rationale: 'Tritan and stainless steel are inherently PFAS-free.', unknowns: [], hasEvidence: true, evidenceCount: 2, decisionDate: '2026-02-16' },
...

  {
    ...
    coatingSummary: 'None',
    verification: { tier: 4 as VerificationTier, claimType: 'inherently_pfas_free', scopeText: 'All Vitamix blenders', rationale: 'Tritan is inherently PFAS-free.', unknowns: [], hasEvidence: true, evidenceCount: 2, decisionDate: '2026-02-16' },
    components: [{ id: 'container', role: 'body', roleLabel: 'Container', material: { id: 'tritan', name: 'Eastman Tritan', slug: 'tritan' }, pfasStatus: 'verified_free' }],
...

  {
    ...
    coatingSummary: 'None',
    verification: { tier: 4 as VerificationTier, claimType: 'inherently_pfas_free', scopeText: 'All Blendtec products', rationale: 'BPA-free plastic is PFAS-free.', unknowns: [], hasEvidence: true, evidenceCount: 2, decisionDate: '2026-02-16' },
    components: [{ id: 'jar', role: 'body', roleLabel: 'Jar', material: { id: 'bpa-free-plastic', name: 'BPA-Free Plastic', slug: 'bpa-free-plastic' }, pfasStatus: 'verified_free' }],
...

  {
    ...
    description: 'Large glass kettle with BPA-free materials. LED-illuminated water window.',
    imageUrl: '/placeholders/products/container-placeholder.svg',
    ...
    materialSummary: 'Borosilicate glass',
    coatingSummary: 'None',
    verification: { tier: 4 as VerificationTier, claimType: 'inherently_pfas_free', scopeText: 'Glass kettles', rationale: 'Glass is inherently PFAS-free.', unknowns: [], hasEvidence: true, evidenceCount: 2, decisionDate: '2026-02-16' },
    components: [{ id: 'body', role: 'body', roleLabel: 'Kettle', material: { id: 'borosilicate-glass', name: 'Borosilicate Glass', slug: 'borosilicate-glass' }, pfasStatus: 'verified_free' }],
...

  {
    ...
    coatingSummary: 'None',
    verification: { tier: 4 as VerificationTier, claimType: 'inherently_pfas_free', scopeText: 'Food processors', rationale: 'BPA-free plastic and stainless steel are PFAS-free.', unknowns: [], hasEvidence: true, evidenceCount: 2, decisionDate: '2026-02-16' },
    components: [{ id: 'blades', role: 'other', roleLabel: 'Blades', material: { id: 'stainless-steel', name: 'Stainless Steel', slug: 'stainless-steel' }, pfasStatus: 'verified_free' }],
...

  {
    ...
    materialSummary: 'BPA-free plastic',
    coatingSummary: 'None',
    verification: { tier: 4 as VerificationTier, claimType: 'inherently_pfas_free', scopeText: 'Food processor accessories', rationale: 'BPA-free plastic is PFAS-free.', unknowns: [], hasEvidence: true, evidenceCount: 2, decisionDate: '2026-02-16' },
