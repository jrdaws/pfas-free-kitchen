...
export const BRANDS: Record<string, Brand> = {
  ...
  caraway: { id: 'caraway', name: 'Caraway', slug: 'caraway', logoUrl: undefined },
  hestan: { id: 'hestan', name: 'Hestan', slug: 'hestan', logoUrl: undefined },
  butterpat: { id: 'butterpat', name: 'Butter Pat', slug: 'butter-pat', logoUrl: undefined },
  misen: { id: 'misen', name: 'Misen', slug: 'misen', logoUrl: undefined },
  mauviel: { id: 'mauviel', name: 'Mauviel', slug: 'mauviel', logoUrl: undefined },
  ...
  // Premium Storage Brands
  planetbox: { id: 'planetbox', name: 'PlanetBox', slug: 'planetbox', logoUrl: undefined },
  weck: { id: 'weck', name: 'Weck', slug: 'weck', logoUrl: undefined },

  // Luxury Copper Brands
  ruffoni: { id: 'ruffoni', name: 'Ruffoni', slug: 'ruffoni', logoUrl: undefined },
  ...
  ankarsrum: { id: 'ankarsrum', name: 'Ankarsrum', slug: 'ankarsrum', logoUrl: undefined },
...
export const PRODUCTS: Product[] = [
  ...
  // ============================================================
  // PREMIUM CERAMIC NON-STICK COOKWARE (PFAS-FREE)
  // ============================================================

  {
    id: 'caraway-fry-pan-set',
    name: 'Caraway Ceramic Nonstick Fry Pan Set with Glass Lids',
    slug: 'caraway-fry-pan-set',
    description: 'Premium ceramic non-stick fry pan set with two 10.5" pans, one 8" pan, and three glass lids. Non-toxic, PTFE & PFOA free. Beautiful minimalist design with magnetic pan rack storage.',
    imageUrl: '/placeholders/products/skillet-placeholder.svg',
    images: [{ url: '/placeholders/products/skillet-placeholder.svg', alt: 'Caraway Fry Pan Set', isPrimary: true }],
    brand: BRANDS.caraway,
    category: CATEGORIES['fry-pans'],
    materialSummary: 'Aluminum core with ceramic coating',
    coatingSummary: 'Ceramic non-stick (PFAS-free)',
    verification: { tier: 4 as VerificationTier, claimType: 'intentionally_pfas_free', scopeText: 'All Caraway cookware', rationale: 'Caraway ceramic coating is independently certified PFAS, PTFE, PFOA, and lead-free.', unknowns: [], hasEvidence: true, evidenceCount: 4, decisionDate: '2026-02-16' },
    components: [{ id: 'body', role: 'body', roleLabel: 'Pan Body', material: { id: 'aluminum', name: 'Aluminum', slug: 'aluminum' }, coating: { id: 'ceramic', name: 'Ceramic Non-Stick', slug: 'ceramic' }, pfasStatus: 'verified_free' }],
    retailers: [{ id: 'caraway-frypan-amazon', retailer: RETAILERS.amazon, url: generateAmazonLink('B0F1HLD3XD'), price: 225, currency: 'USD', inStock: true }],
    features: { inductionCompatible: true, ovenSafeTempF: 550, dishwasherSafe: true },
  },

  {
    id: 'caraway-cookware-set-12pc',
    name: 'Caraway Nonstick Ceramic Cookware Set 12-Piece',
    slug: 'caraway-cookware-set-12pc',
    description: 'Complete ceramic non-stick cookware set including fry pan, saucepan, sauté pan, dutch oven, and lids. Award-winning design with magnetic pan storage.',
    imageUrl: '/placeholders/products/skillet-placeholder.svg',
    images: [{ url: '/placeholders/products/skillet-placeholder.svg', alt: 'Caraway Cookware Set', isPrimary: true }],
    brand: BRANDS.caraway,
    category: CATEGORIES['cookware-sets'],
    materialSummary: 'Aluminum core with ceramic coating',
    coatingSummary: 'Ceramic non-stick (PFAS-free)',
    verification: { tier: 4 as VerificationTier, claimType: 'intentionally_pfas_free', scopeText: 'All Caraway cookware', rationale: 'Caraway ceramic coating is independently certified PFAS, PTFE, PFOA, and lead-free.', unknowns: [], hasEvidence: true, evidenceCount: 4, decisionDate: '2026-02-16' },
    components: [{ id: 'body', role: 'body', roleLabel: 'Cookware', material: { id: 'aluminum', name: 'Aluminum', slug: 'aluminum' }, coating: { id: 'ceramic', name: 'Ceramic Non-Stick', slug: 'ceramic' }, pfasStatus: 'verified_free' }],
    retailers: [{ id: 'caraway-set-amazon', retailer: RETAILERS.amazon, url: generateAmazonLink('B08BX5RFN5'), price: 395, currency: 'USD', inStock: true }],
    features: { inductionCompatible: true, ovenSafeTempF: 550, dishwasherSafe: true },
  },

  {
    id: 'ourplace-always-pan',
    name: 'Our Place Always Pan 2.0',
    slug: 'ourplace-always-pan',
    description: 'The viral 10-in-1 ceramic non-stick pan. Replaces 8 pieces of cookware. Includes modular lid, steamer basket, and beechwood spatula. Toxin-free ceramic coating.',
    imageUrl: '/placeholders/products/skillet-placeholder.svg',
    images: [{ url: '/placeholders/products/skillet-placeholder.svg', alt: 'Our Place Always Pan', isPrimary: true }],
    brand: BRANDS.ourplace,
    category: CATEGORIES['fry-pans'],
    materialSummary: 'Aluminum with ceramic coating',
    coatingSummary: 'Ceramic non-stick (PFAS-free)',
    verification: { tier: 4 as VerificationTier, claimType: 'intentionally_pfas_free', scopeText: 'All Our Place cookware', rationale: 'Our Place ceramic coating is certified PFAS, PTFE, PFOA-free. Third-party tested.', unknowns: [], hasEvidence: true, evidenceCount: 4, decisionDate: '2026-02-16' },
    components: [{ id: 'body', role: 'body', roleLabel: 'Pan Body', material: { id: 'aluminum', name: 'Aluminum', slug: 'aluminum' }, coating: { id: 'ceramic', name: 'Ceramic Non-Stick', slug: 'ceramic' }, pfasStatus: 'verified_free' }],
    retailers: [{ id: 'ourplace-always-amazon', retailer: RETAILERS.amazon, url: generateAmazonLink('B0CLTFJK7C'), price: 150, currency: 'USD', inStock: true }],
    features: { inductionCompatible: true, ovenSafeTempF: 450, dishwasherSafe: false },
  },

  {
    id: 'greenpan-valencia-pro-11',
    name: 'GreenPan Valencia Pro 11" Ceramic Non-Stick Frypan',
    slug: 'greenpan-valencia-pro-11',
    description: 'Professional-grade ceramic non-stick with Magneto induction base. Thermolon Diamond coating withstands high heat. Hard anodized for durability.',
    imageUrl: '/placeholders/products/skillet-placeholder.svg',
    images: [{ url: '/placeholders/products/skillet-placeholder.svg', alt: 'GreenPan Valencia Pro', isPrimary: true }],
    brand: BRANDS.greenpan,
    category: CATEGORIES['fry-pans'],
    materialSummary: 'Hard anodized aluminum',
    coatingSummary: 'Thermolon Diamond ceramic (PFAS-free)',
    verification: { tier: 4 as VerificationTier, claimType: 'intentionally_pfas_free', scopeText: 'All GreenPan products', rationale: 'Thermolon ceramic coating verified PFAS-free by independent labs. GreenPan pioneered ceramic non-stick.', unknowns: [], hasEvidence: true, evidenceCount: 5, decisionDate: '2026-02-16' },
    components: [{ id: 'body', role: 'body', roleLabel: 'Pan Body', material: { id: 'hard-anodized', name: 'Hard Anodized Aluminum', slug: 'hard-anodized' }, coating: { id: 'thermolon', name: 'Thermolon Diamond', slug: 'thermolon' }, pfasStatus: 'verified_free' }],
    retailers: [{ id: 'greenpan-valencia-amazon', retailer: RETAILERS.amazon, url: generateAmazonLink('B0B14F4B1N'), price: 90, currency: 'USD', inStock: true }],
    features: { inductionCompatible: true, ovenSafeTempF: 600, dishwasherSafe: true },
  },

  {
    id: 'madein-ceramiclad-frypan',
    name: 'Made In CeramiClad Frying Pan 10"',
    slug: 'madein-ceramiclad-frypan',
    description: 'Professional ceramic non-stick with 4mm aluminum core for superior heat distribution. Made with the same quality as their stainless steel line.',
    imageUrl: '/placeholders/products/skillet-placeholder.svg',
    images: [{ url: '/placeholders/products/skillet-placeholder.svg', alt: 'Made In CeramiClad', isPrimary: true }],
    brand: BRANDS.madein,
    category: CATEGORIES['fry-pans'],
    materialSummary: 'Aluminum with ceramic coating',
    coatingSummary: 'Ceramic non-stick (PFAS-free)',
    verification: { tier: 4 as VerificationTier, claimType: 'intentionally_pfas_free', scopeText: 'Made In CeramiClad line', rationale: 'Made In ceramic coating is PFAS, PTFE, PFOA-free. Professional restaurant quality.', unknowns: [], hasEvidence: true, evidenceCount: 3, decisionDate: '2026-02-16' },
    components: [{ id: 'body', role: 'body', roleLabel: 'Pan Body', material: { id: 'aluminum', name: 'Aluminum', slug: 'aluminum' }, coating: { id: 'ceramic', name: 'Ceramic Non-Stick', slug: 'ceramic' }, pfasStatus: 'verified_free' }],
    retailers: [{ id: 'madein-ceramiclad-amazon', retailer: RETAILERS.amazon, url: generateAmazonLink('B09QPRJ2L5'), price: 149, currency: 'USD', inStock: true }],
    features: { inductionCompatible: true, ovenSafeTempF: 600, dishwasherSafe: true },
  },

  // ============================================================
  // PREMIUM CAST IRON (HEIRLOOM QUALITY)
  // ============================================================

  {
    id: 'smithey-no12-skillet',
    name: 'Smithey No. 12 Traditional Cast Iron Skillet',
    slug: 'smithey-no12-skillet',
    description: 'Heirloom-quality cast iron handcrafted in Charleston, SC. Ultra-smooth polished cooking surface. Superior heat retention for perfect searing. Lifetime guarantee.',
    imageUrl: '/placeholders/products/skillet-placeholder.svg',
    images: [{ url: '/placeholders/products/skillet-placeholder.svg', alt: 'Smithey No. 12 Skillet', isPrimary: true }],
    brand: BRANDS.smithey,
    category: CATEGORIES['skillets'],
    materialSummary: 'Cast iron with polished finish',
    coatingSummary: 'Pre-seasoned with natural oils',
    verification: { tier: 4 as VerificationTier, claimType: 'inherently_pfas_free', scopeText: 'All Smithey cast iron', rationale: 'Cast iron with natural oil seasoning is inherently PFAS-free. Made in USA.', unknowns: [], hasEvidence: true, evidenceCount: 3, decisionDate: '2026-02-16' },
    components: [{ id: 'body', role: 'body', roleLabel: 'Skillet Body', material: { id: 'cast-iron', name: 'Polished Cast Iron', slug: 'cast-iron' }, pfasStatus: 'verified_free' }],
    retailers: [{ id: 'smithey-no12-amazon', retailer: RETAILERS.amazon, url: generateAmazonLink('B01N5OTVP0'), price: 220, currency: 'USD', inStock: true }],
    features: { inductionCompatible: true, ovenSafeTempF: 1000, dishwasherSafe: false },
  },

  {
    id: 'smithey-no10-skillet',
    name: 'Smithey No. 10 Cast Iron Skillet',
    slug: 'smithey-no10-skillet',
    description: 'The everyday workhorse. 10-inch polished cast iron skillet with exceptional heat retention and food release. Handcrafted in USA.',
    imageUrl: '/placeholders/products/skillet-placeholder.svg',
    images: [{ url: '/placeholders/products/skillet-placeholder.svg', alt: 'Smithey No. 10 Skillet', isPrimary: true }],
    brand: BRANDS.smithey,
    category: CATEGORIES['skillets'],
    materialSummary: 'Cast iron with polished finish',
    coatingSummary: 'Pre-seasoned with natural oils',
    verification: { tier: 4 as VerificationTier, claimType: 'inherently_pfas_free', scopeText: 'All Smithey cast iron', rationale: 'Cast iron with natural oil seasoning is inherently PFAS-free.', unknowns: [], hasEvidence: true, evidenceCount: 3, decisionDate: '2026-02-16' },
    components: [{ id: 'body', role: 'body', roleLabel: 'Skillet Body', material: { id: 'cast-iron', name: 'Polished Cast Iron', slug: 'cast-iron' }, pfasStatus: 'verified_free' }],
    retailers: [{ id: 'smithey-no10-amazon', retailer: RETAILERS.amazon, url: generateAmazonLink('B074J6F1WK'), price: 180, currency: 'USD', inStock: true }],
    features: { inductionCompatible: true, ovenSafeTempF: 1000, dishwasherSafe: false },
  },

  {
    ...
    name: 'Field Company No. 8 Cast Iron Skillet',
    slug: 'field-company-no8-skillet',
    description: 'Lighter, smoother cast iron inspired by vintage designs. 10.25" machined cooking surface. Half the weight of typical cast iron. Made in USA.',
    imageUrl: '/placeholders/products/skillet-placeholder.svg',
    images: [{ url: '/placeholders/products/skillet-placeholder.svg', alt: 'Field Company No. 8', isPrimary: true }],
    brand: BRANDS.fieldcompany,
    category: CATEGORIES['skillets'],
    materialSummary: 'Lighter-weight cast iron',
    coatingSummary: 'Pre-seasoned with natural oils',
    verification: { tier: 4 as VerificationTier, claimType: 'inherently_pfas_free', scopeText: 'All Field Company cast iron', rationale: 'Cast iron with natural oil seasoning is inherently PFAS-free. Made in USA.', unknowns: [], hasEvidence: true, evidenceCount: 3, decisionDate: '2026-02-16' },
    components: [{ id: 'body', role: 'body', roleLabel: 'Skillet Body', material: { id: 'cast-iron', name: 'Cast Iron', slug: 'cast-iron' }, pfasStatus: 'verified_free' }],
    retailers: [{ id: 'field-no8-amazon', retailer: RETAILERS.amazon, url: generateAmazonLink('B0C62Z1MTW'), price: 165, currency: 'USD', inStock: true }],
    features: { inductionCompatible: true, ovenSafeTempF: 700, dishwasherSafe: false },
  },

  {
    id: 'field-company-no10-skillet',
    name: 'Field Company No. 10 Cast Iron Skillet',
    slug: 'field-company-no10-skillet',
    description: 'The full-size lightweight cast iron. 11.5" cooking surface with smooth machined finish for excellent food release. Lighter than traditional cast iron.',
    imageUrl: '/placeholders/products/skillet-placeholder.svg',
    images: [{ url: '/placeholders/products/skillet-placeholder.svg', alt: 'Field Company No. 10', isPrimary: true }],
    brand: BRANDS.fieldcompany,
    category: CATEGORIES['skillets'],
    materialSummary: 'Lighter-weight cast iron',
    coatingSummary: 'Pre-seasoned with natural oils',
    verification: { tier: 4 as VerificationTier, claimType: 'inherently_pfas_free', scopeText: 'All Field Company cast iron', rationale: 'Cast iron with natural oil seasoning is inherently PFAS-free. Made in USA.', unknowns: [], hasEvidence: true, evidenceCount: 3, decisionDate: '2026-02-16' },
    components: [{ id: 'body', role: 'body', roleLabel: 'Skillet Body', material: { id: 'cast-iron', name: 'Cast Iron', slug: 'cast-iron' }, pfasStatus: 'verified_free' }],
    retailers: [{ id: 'field-no10-amazon', retailer: RETAILERS.amazon, url: generateAmazonLink('B07YK89HDZ'), price: 195, currency: 'USD', inStock: true }],
    features: { inductionCompatible: true, ovenSafeTempF: 700, dishwasherSafe: false },
  },

  {
    ...
    slug: 'finex-10-skillet',
    description: 'Distinctive octagonal design made in Portland, Oregon. Extra-thick walls for superior heat retention. Stainless steel spring handle stays cool. Premium machined cooking surface.',
    imageUrl: '/placeholders/products/skillet-placeholder.svg',
    images: [{ url: '/placeholders/products/skillet-placeholder.svg', alt: 'FINEX Cast Iron Skillet', isPrimary: true }],
    brand: BRANDS.finex,
    category: CATEGORIES['skillets'],
    materialSummary: 'Heavy cast iron with octagonal design',
    coatingSummary: 'Pre-seasoned with organic flaxseed oil',
    verification: { tier: 4 as VerificationTier, claimType: 'inherently_pfas_free', scopeText: 'All FINEX cast iron', rationale: 'Cast iron with natural oil seasoning is inherently PFAS-free. Made in USA.', unknowns: [], hasEvidence: true, evidenceCount: 3, decisionDate: '2026-02-16' },
    components: [{ id: 'body', role: 'body', roleLabel: 'Skillet Body', material: { id: 'cast-iron', name: 'Cast Iron', slug: 'cast-iron' }, pfasStatus: 'verified_free' }],
    retailers: [{ id: 'finex-10-amazon', retailer: RETAILERS.amazon, url: generateAmazonLink('B00L9LD8OI'), price: 195, currency: 'USD', inStock: true }],
    features: { inductionCompatible: true, ovenSafeTempF: 900, dishwasherSafe: false },
  },

  {
    id: 'finex-12-skillet',
    name: 'FINEX 12" Cast Iron Skillet',
    slug: 'finex-12-skillet',
    description: 'Large capacity octagonal skillet for family cooking. Extra-thick for professional-level heat retention. Cool-touch spring handle. Made in Oregon.',
    imageUrl: '/placeholders/products/skillet-placeholder.svg',
    images: [{ url: '/placeholders/products/skillet-placeholder.svg', alt: 'FINEX 12" Skillet', isPrimary: true }],
    brand: BRANDS.finex,
    category: CATEGORIES['skillets'],
    materialSummary: 'Heavy cast iron with octagonal design',
    coatingSummary: 'Pre-seasoned with organic flaxseed oil',
    verification: { tier: 4 as VerificationTier, claimType: 'inherently_pfas_free', scopeText: 'All FINEX cast iron', rationale: 'Cast iron with natural oil seasoning is inherently PFAS-free. Made in USA.', unknowns: [], hasEvidence: true, evidenceCount: 3, decisionDate: '2026-02-16' },
    components: [{ id: 'body', role: 'body', roleLabel: 'Skillet Body', material: { id: 'cast-iron', name: 'Cast Iron', slug: 'cast-iron' }, pfasStatus: 'verified_free' }],
    retailers: [{ id: 'finex-12-amazon', retailer: RETAILERS.amazon, url: generateAmazonLink('B00L9LD9ES'), price: 275, currency: 'USD', inStock: true }],
    features: { inductionCompatible: true, ovenSafeTempF: 900, dishwasherSafe: false },
  },

  // ============================================================
  // PREMIUM STAINLESS STEEL (PROFESSIONAL GRADE)
  // ============================================================

  {
    id: 'allclad-d5-frypan-12',
    name: 'All-Clad D5 Brushed Stainless 12" Fry Pan',
    slug: 'allclad-d5-frypan-12',
    description: '5-ply stainless steel with alternating layers of steel and aluminum for optimal heat distribution. Made in USA. Best heat retention in its class.',
    imageUrl: '/placeholders/products/skillet-placeholder.svg',
    images: [{ url: '/placeholders/products/skillet-placeholder.svg', alt: 'All-Clad D5 Fry Pan', isPrimary: true }],
    brand: BRANDS.allclad,
    category: CATEGORIES['fry-pans'],
    materialSummary: '5-ply stainless steel with aluminum core',
    coatingSummary: 'None - bare stainless steel',
    verification: { tier: 4 as VerificationTier, claimType: 'inherently_pfas_free', scopeText: 'All stainless steel cookware', rationale: 'Stainless steel is inherently PFAS-free. Made in USA since 1971.', unknowns: [], hasEvidence: true, evidenceCount: 4, decisionDate: '2026-02-16' },
    components: [{ id: 'body', role: 'body', roleLabel: 'Pan Body', material: { id: 'stainless-steel', name: '5-Ply Stainless Steel', slug: 'stainless-steel' }, pfasStatus: 'verified_free' }],
    retailers: [{ id: 'allclad-d5-fry-amazon', retailer: RETAILERS.amazon, url: generateAmazonLink('B005P0ON4W'), price: 200, currency: 'USD', inStock: true }],
    features: { inductionCompatible: true, ovenSafeTempF: 600, dishwasherSafe: true },
  },

  {
    id: 'allclad-copper-core-frypan-12',
    name: 'All-Clad Copper Core 12" Fry Pan',
    slug: 'allclad-copper-core-frypan-12',
    description: 'The ultimate in heat responsiveness. Copper core between layers of aluminum and stainless steel for instant heat control. Made in USA.',
    imageUrl: '/placeholders/products/skillet-placeholder.svg',
    images: [{ url: '/placeholders/products/skillet-placeholder.svg', alt: 'All-Clad Copper Core', isPrimary: true }],
    brand: BRANDS.allclad,
    category: CATEGORIES['fry-pans'],
    materialSummary: '5-ply with copper core',
    coatingSummary: 'None - bare stainless steel',
    verification: { tier: 4 as VerificationTier, claimType: 'inherently_pfas_free', scopeText: 'All stainless steel cookware', rationale: 'Stainless steel with copper is inherently PFAS-free.', unknowns: [], hasEvidence: true, evidenceCount: 4, decisionDate: '2026-02-16' },
    components: [{ id: 'body', role: 'body', roleLabel: 'Pan Body', material: { id: 'stainless-steel', name: 'Copper Core Stainless', slug: 'stainless-steel' }, pfasStatus: 'verified_free' }],
    retailers: [{ id: 'allclad-copper-fry-amazon', retailer: RETAILERS.amazon, url: generateAmazonLink('B00005AL14'), price: 300, currency: 'USD', inStock: true }],
    features: { inductionCompatible: true, ovenSafeTempF: 600, dishwasherSafe: true },
  },

  {
    id: 'hestan-nanobond-frypan-11',
    name: 'Hestan NanoBond 11" Titanium Frying Pan',
    slug: 'hestan-nanobond-frypan-11',
    description: 'Revolutionary titanium-infused surface is 400% harder than regular stainless. Withstands up to 1050°F. Metal utensil safe. Made in Italy.',
    imageUrl: '/placeholders/products/skillet-placeholder.svg',
    images: [{ url: '/placeholders/products/skillet-placeholder.svg', alt: 'Hestan NanoBond', isPrimary: true }],
    brand: BRANDS.hestan,
    category: CATEGORIES['fry-pans'],
    materialSummary: 'Titanium-infused stainless steel',
    coatingSummary: 'NanoBond titanium (PFAS-free)',
    verification: { tier: 4 as VerificationTier, claimType: 'inherently_pfas_free', scopeText: 'All Hestan NanoBond', rationale: 'Titanium and stainless steel are inherently PFAS-free. Made in Italy.', unknowns: [], hasEvidence: true, evidenceCount: 3, decisionDate: '2026-02-16' },
    components: [{ id: 'body', role: 'body', roleLabel: 'Pan Body', material: { id: 'titanium-stainless', name: 'NanoBond Titanium', slug: 'titanium-stainless' }, pfasStatus: 'verified_free' }],
    retailers: [{ id: 'hestan-nanobond-amazon', retailer: RETAILERS.amazon, url: generateAmazonLink('B07NZ8HTKQ'), price: 250, currency: 'USD', inStock: true }],
    features: { inductionCompatible: true, ovenSafeTempF: 1050, dishwasherSafe: true },
  },

  {
    id: 'demeyere-industry-frypan-11',
    name: 'Demeyere Industry 5-Ply 11" Fry Pan',
    slug: 'demeyere-industry-frypan-11',
    description: 'Belgian engineering excellence. 5-ply stainless steel with TriplInduc technology for perfect induction performance. Welded handles for durability.',
    imageUrl: '/placeholders/products/skillet-placeholder.svg',
    images: [{ url: '/placeholders/products/skillet-placeholder.svg', alt: 'Demeyere Industry Fry Pan', isPrimary: true }],
    brand: BRANDS.demeyere,
    category: CATEGORIES['fry-pans'],
    materialSummary: '5-ply stainless steel',
    coatingSummary: 'None - bare stainless steel',
    verification: { tier: 4 as VerificationTier, claimType: 'inherently_pfas_free', scopeText: 'All stainless steel cookware', rationale: 'Stainless steel is inherently PFAS-free. Made in Belgium.', unknowns: [], hasEvidence: true, evidenceCount: 3, decisionDate: '2026-02-16' },
    components: [{ id: 'body', role: 'body', roleLabel: 'Pan Body', material: { id: 'stainless-steel', name: '5-Ply Stainless Steel', slug: 'stainless-steel' }, pfasStatus: 'verified_free' }],
    retailers: [{ id: 'demeyere-industry-fry-amazon', retailer: RETAILERS.amazon, url: generateAmazonLink('B00KQGV7PM'), price: 200, currency: 'USD', inStock: true }],
    features: { inductionCompatible: true, ovenSafeTempF: 500, dishwasherSafe: true },
  },

  {
    id: 'madein-stainless-frypan-12',
    name: 'Made In 12" Stainless Steel Frying Pan',
    slug: 'madein-stainless-frypan-12',
    description: '5-ply stainless clad construction used by top restaurants. Direct-to-consumer pricing without the markup. Made with the same factories as All-Clad.',
    imageUrl: '/placeholders/products/skillet-placeholder.svg',
    images: [{ url: '/placeholders/products/skillet-placeholder.svg', alt: 'Made In Stainless Fry Pan', isPrimary: true }],
    brand: BRANDS.madein,
    category: CATEGORIES['fry-pans'],
    materialSummary: '5-ply stainless steel',
    coatingSummary: 'None - bare stainless steel',
    verification: { tier: 4 as VerificationTier, claimType: 'inherently_pfas_free', scopeText: 'All stainless steel cookware', rationale: 'Stainless steel is inherently PFAS-free. Restaurant quality.', unknowns: [], hasEvidence: true, evidenceCount: 3, decisionDate: '2026-02-16' },
    components: [{ id: 'body', role: 'body', roleLabel: 'Pan Body', material: { id: 'stainless-steel', name: '5-Ply Stainless Steel', slug: 'stainless-steel' }, pfasStatus: 'verified_free' }],
    retailers: [{ id: 'madein-stainless-fry-amazon', retailer: RETAILERS.amazon, url: generateAmazonLink('B07M5D2PGZ'), price: 119, currency: 'USD', inStock: true }],
    features: { inductionCompatible: true, ovenSafeTempF: 800, dishwasherSafe: true },
  },

  // ============================================================
  // PREMIUM CARBON STEEL (PROFESSIONAL)
  // ============================================================

  {
    id: 'debuyer-mineral-b-12',
    name: 'de Buyer Mineral B Carbon Steel Fry Pan 12.5"',
    slug: 'debuyer-mineral-b-12',
    description: 'French carbon steel with organic beeswax finish. 99% pure iron develops natural non-stick patina. Used by professional chefs worldwide. Made in France.',
    imageUrl: '/placeholders/products/skillet-placeholder.svg',
    images: [{ url: '/placeholders/products/skillet-placeholder.svg', alt: 'de Buyer Mineral B', isPrimary: true }],
    brand: BRANDS.debuyer,
    category: CATEGORIES['fry-pans'],
    materialSummary: 'Carbon steel (99% iron)',
    coatingSummary: 'Organic beeswax finish',
    verification: { tier: 4 as VerificationTier, claimType: 'inherently_pfas_free', scopeText: 'All carbon steel cookware', rationale: 'Carbon steel with natural beeswax is inherently PFAS-free. Made in France since 1830.', unknowns: [], hasEvidence: true, evidenceCount: 4, decisionDate: '2026-02-16' },
    components: [{ id: 'body', role: 'body', roleLabel: 'Pan Body', material: { id: 'carbon-steel', name: 'Carbon Steel', slug: 'carbon-steel' }, pfasStatus: 'verified_free' }],
    retailers: [{ id: 'debuyer-mineral-12-amazon', retailer: RETAILERS.amazon, url: generateAmazonLink('B00462QP16'), price: 60, currency: 'USD', inStock: true }],
    features: { inductionCompatible: true, ovenSafeTempF: 600, dishwasherSafe: false },
  },

  {
    id: 'madein-carbon-steel-12',
    name: 'Made In Blue Carbon Steel Frying Pan 12"',
    slug: 'madein-carbon-steel-12',
    description: 'Restaurant-grade carbon steel at direct-to-consumer prices. Pre-seasoned and ready to use. Lighter than cast iron with similar performance.',
    imageUrl: '/placeholders/products/skillet-placeholder.svg',
    images: [{ url: '/placeholders/products/skillet-placeholder.svg', alt: 'Made In Carbon Steel', isPrimary: true }],
    brand: BRANDS.madein,
    category: CATEGORIES['fry-pans'],
    materialSummary: 'Blue carbon steel',
    coatingSummary: 'Pre-seasoned with natural oils',
    verification: { tier: 4 as VerificationTier, claimType: 'inherently_pfas_free', scopeText: 'All carbon steel cookware', rationale: 'Carbon steel with natural oil seasoning is inherently PFAS-free.', unknowns: [], hasEvidence: true, evidenceCount: 3, decisionDate: '2026-02-16' },
    components: [{ id: 'body', role: 'body', roleLabel: 'Pan Body', material: { id: 'carbon-steel', name: 'Blue Carbon Steel', slug: 'carbon-steel' }, pfasStatus: 'verified_free' }],
    retailers: [{ id: 'madein-carbon-amazon', retailer: RETAILERS.amazon, url: generateAmazonLink('B07M5CTJSC'), price: 89, currency: 'USD', inStock: true }],
    features: { inductionCompatible: true, ovenSafeTempF: 1200, dishwasherSafe: false },
  },

  {
    id: 'mauviel-msteel-frypan-11',
    name: 'Mauviel M\'steel Carbon Steel Fry Pan 11"',
    slug: 'mauviel-msteel-frypan-11',
    description: 'Handcrafted in Normandy, France since 1830. Professional-grade carbon steel used by Michelin-starred chefs. Develops perfect patina over time.',
    imageUrl: '/placeholders/products/skillet-placeholder.svg',
    images: [{ url: '/placeholders/products/skillet-placeholder.svg', alt: 'Mauviel M\'steel', isPrimary: true }],
    brand: BRANDS.mauviel,
    category: CATEGORIES['fry-pans'],
    materialSummary: 'French carbon steel',
    coatingSummary: 'Organic beeswax finish',
    verification: { tier: 4 as VerificationTier, claimType: 'inherently_pfas_free', scopeText: 'All carbon steel cookware', rationale: 'Carbon steel with natural beeswax is inherently PFAS-free. Made in France since 1830.', unknowns: [], hasEvidence: true, evidenceCount: 4, decisionDate: '2026-02-16' },
    components: [{ id: 'body', role: 'body', roleLabel: 'Pan Body', material: { id: 'carbon-steel', name: 'Carbon Steel', slug: 'carbon-steel' }, pfasStatus: 'verified_free' }],
    retailers: [{ id: 'mauviel-msteel-amazon', retailer: RETAILERS.amazon, url: generateAmazonLink('B002LQ81KC'), price: 80, currency: 'USD', inStock: true }],
    features: { inductionCompatible: true, ovenSafeTempF: 700, dishwasherSafe: false },
  },

  // ============================================================
  // PREMIUM ENAMELED CAST IRON (HEIRLOOM)
  // ============================================================

  {
    id: 'lecreuset-signature-skillet-11',
    name: 'Le Creuset Signature Enameled Cast Iron Skillet 11.75"',
    slug: 'lecreuset-signature-skillet-11',
    description: 'The gold standard in enameled cast iron. Made in France since 1925. Black satin interior enamel is PFAS-free. Lifetime warranty.',
    imageUrl: '/placeholders/products/skillet-placeholder.svg',
    images: [{ url: '/placeholders/products/skillet-placeholder.svg', alt: 'Le Creuset Skillet', isPrimary: true }],
    brand: BRANDS.lecreuset,
    category: CATEGORIES['fry-pans'],
    materialSummary: 'Enameled cast iron',
    coatingSummary: 'Black satin enamel interior',
    verification: { tier: 4 as VerificationTier, claimType: 'inherently_pfas_free', scopeText: 'All Le Creuset enameled cast iron', rationale: 'Enamel is glass-based and inherently PFAS-free. Made in France since 1925.', unknowns: [], hasEvidence: true, evidenceCount: 5, decisionDate: '2026-02-16' },
    components: [{ id: 'body', role: 'body', roleLabel: 'Skillet Body', material: { id: 'cast-iron', name: 'Enameled Cast Iron', slug: 'cast-iron' }, coating: { id: 'enamel', name: 'Enamel', slug: 'enamel' }, pfasStatus: 'verified_free' }],
    retailers: [{ id: 'lecreuset-skillet-amazon', retailer: RETAILERS.amazon, url: generateAmazonLink('B00005QFNP'), price: 220, currency: 'USD', inStock: true }],
    features: { inductionCompatible: true, ovenSafeTempF: 500, dishwasherSafe: true },
  },

  {
    id: 'staub-frypan-10',
    name: 'Staub Cast Iron 10" Fry Pan',
    slug: 'staub-frypan-10',
    description: 'French enameled cast iron with matte black enamel interior. The choice of professional chefs. Superior heat retention for perfect browning. Made in France.',
    imageUrl: '/placeholders/products/skillet-placeholder.svg',
    images: [{ url: '/placeholders/products/skillet-placeholder.svg', alt: 'Staub Fry Pan', isPrimary: true }],
    brand: BRANDS.staub,
    category: CATEGORIES['fry-pans'],
    materialSummary: 'Enameled cast iron',
    coatingSummary: 'Matte black enamel interior',
    verification: { tier: 4 as VerificationTier, claimType: 'inherently_pfas_free', scopeText: 'All Staub enameled cast iron', rationale: 'Enamel is glass-based and inherently PFAS-free. Made in France.', unknowns: [], hasEvidence: true, evidenceCount: 5, decisionDate: '2026-02-16' },
    components: [{ id: 'body', role: 'body', roleLabel: 'Pan Body', material: { id: 'cast-iron', name: 'Enameled Cast Iron', slug: 'cast-iron' }, coating: { id: 'enamel', name: 'Enamel', slug: 'enamel' }, pfasStatus: 'verified_free' }],
    retailers: [{ id: 'staub-frypan-amazon', retailer: RETAILERS.amazon, url: generateAmazonLink('B0060DJNWY'), price: 180, currency: 'USD', inStock: true }],
    features: { inductionCompatible: true, ovenSafeTempF: 500, dishwasherSafe: true },
  },

  // ============================================================
  // ULTRA-PREMIUM LUXURY COPPER COOKWARE
  // ============================================================

  {
    id: 'mauviel-m150s-frypan-12',
    name: "Mauviel M'Heritage M'150 S Copper Fry Pan 12"",
    slug: 'mauviel-m150s-frypan-12',
    description: 'Handcrafted in Normandy, France since 1830. 1.5mm copper with stainless steel lining. Unparalleled heat responsiveness for precision cooking. The choice of Michelin-starred chefs.',
    imageUrl: '/placeholders/products/skillet-placeholder.svg',
    images: [{ url: '/placeholders/products/skillet-placeholder.svg', alt: 'Mauviel Copper Fry Pan', isPrimary: true }],
    brand: BRANDS.mauviel,
    category: CATEGORIES['fry-pans'],
    materialSummary: '90% copper, stainless steel lining',
    coatingSummary: 'None - bare stainless interior',
    verification: { tier: 4 as VerificationTier, claimType: 'inherently_pfas_free', scopeText: 'All copper and stainless cookware', rationale: 'Copper and stainless steel are inherently PFAS-free. Made in France since 1830.', unknowns: [], hasEvidence: true, evidenceCount: 4, decisionDate: '2026-02-16' },
    components: [{ id: 'body', role: 'body', roleLabel: 'Pan Body', material: { id: 'copper', name: 'Copper', slug: 'copper' }, pfasStatus: 'verified_free' }],
    retailers: [{ id: 'mauviel-fry-amazon', retailer: RETAILERS.amazon, url: generateAmazonLink('B00BLTI0F6'), price: 350, currency: 'USD', inStock: true }],
    features: { inductionCompatible: false, ovenSafeTempF: 680, dishwasherSafe: false },
  },

  {
    id: 'mauviel-m150s-saucepan-2qt',
    name: "Mauviel M'Heritage M'150 S Copper Saucepan 2 Qt",
    slug: 'mauviel-m150s-saucepan-2qt',
    description: 'Essential French copper saucepan for sauces, reductions, and delicate cooking. Superior heat control impossible with other materials. Handcrafted in Normandy.',
    imageUrl: '/placeholders/products/skillet-placeholder.svg',
    images: [{ url: '/placeholders/products/skillet-placeholder.svg', alt: 'Mauviel Copper Saucepan', isPrimary: true }],
    brand: BRANDS.mauviel,
    category: CATEGORIES['saucepans'],
    materialSummary: '90% copper, stainless steel lining',
    coatingSummary: 'None - bare stainless interior',
    verification: { tier: 4 as VerificationTier, claimType: 'inherently_pfas_free', scopeText: 'All copper and stainless cookware', rationale: 'Copper and stainless steel are inherently PFAS-free.', unknowns: [], hasEvidence: true, evidenceCount: 4, decisionDate: '2026-02-16' },
    components: [{ id: 'body', role: 'body', roleLabel: 'Pan Body', material: { id: 'copper', name: 'Copper', slug: 'copper' }, pfasStatus: 'verified_free' }],
    retailers: [{ id: 'mauviel-sauce-amazon', retailer: RETAILERS.amazon, url: generateAmazonLink('B000063Y0H'), price: 290, currency: 'USD', inStock: true }],
    features: { inductionCompatible: false, ovenSafeTempF: 680, dishwasherSafe: false },
  },

  {
    id: 'mauviel-m6s-frypan-11-induction',
    name: "Mauviel M'6 S Induction-Compatible Copper Fry Pan 11"",
    slug: 'mauviel-m6s-frypan-11-induction',
    description: '6-layer construction with magnetic stainless steel base for induction compatibility. All the beauty and performance of copper, now works on induction cooktops.',
    imageUrl: '/placeholders/products/skillet-placeholder.svg',
    images: [{ url: '/placeholders/products/skillet-placeholder.svg', alt: 'Mauviel M6S Copper Fry Pan', isPrimary: true }],
    brand: BRANDS.mauviel,
    category: CATEGORIES['fry-pans'],
    materialSummary: '6-ply copper with magnetic stainless base',
    coatingSummary: 'None - bare stainless interior',
    verification: { tier: 4 as VerificationTier, claimType: 'inherently_pfas_free', scopeText: 'All copper and stainless cookware', rationale: 'Copper and stainless steel are inherently PFAS-free.', unknowns: [], hasEvidence: true, evidenceCount: 4, decisionDate: '2026-02-16' },
    components: [{ id: 'body', role: 'body', roleLabel: 'Pan Body', material: { id: 'copper', name: 'Copper', slug: 'copper' }, pfasStatus: 'verified_free' }],
    retailers: [{ id: 'mauviel-m6s-amazon', retailer: RETAILERS.amazon, url: generateAmazonLink('B0BLGXDC6H'), price: 400, currency: 'USD', inStock: true }],
    features: { inductionCompatible: true, ovenSafeTempF: 680, dishwasherSafe: false },
  },

  {
    id: 'ruffoni-historia-stockpot-8qt',
    name: 'Ruffoni Historia Hammered Copper Stock Pot 8 Qt',
    slug: 'ruffoni-historia-stockpot-8qt',
    description: 'Italian artisan hammered copper with hand-tinned interior. Each piece is handcrafted using techniques passed down for generations. Heirloom quality meant to last forever.',
    imageUrl: '/placeholders/products/skillet-placeholder.svg',
    images: [{ url: '/placeholders/products/skillet-placeholder.svg', alt: 'Ruffoni Historia Stock Pot', isPrimary: true }],
    brand: BRANDS.ruffoni,
    category: CATEGORIES['stock-pots'],
    materialSummary: 'Hammered copper with tin lining',
    coatingSummary: 'Hand-applied tin interior',
    verification: { tier: 4 as VerificationTier, claimType: 'inherently_pfas_free', scopeText: 'All copper and tin cookware', rationale: 'Copper and tin are inherently PFAS-free. Traditional artisan methods.', unknowns: [], hasEvidence: true, evidenceCount: 4, decisionDate: '2026-02-16' },
    components: [{ id: 'body', role: 'body', roleLabel: 'Pot Body', material: { id: 'copper', name: 'Hammered Copper', slug: 'copper' }, pfasStatus: 'verified_free' }],
    retailers: [{ id: 'ruffoni-stock-amazon', retailer: RETAILERS.amazon, url: generateAmazonLink('B00M3IPQZ2'), price: 690, currency: 'USD', inStock: true }],
    features: { inductionCompatible: false, ovenSafeTempF: 450, dishwasherSafe: false },
  },

  {
    id: 'ruffoni-opus-saucepan-2qt',
    name: 'Ruffoni Opus Prima Hammered Copper Saucepan 2 Qt',
    slug: 'ruffoni-opus-saucepan-2qt',
    description: 'Handcrafted hammered copper with stainless steel interior. Decorative cast iron handles. Museum-quality beauty with professional performance.',
    imageUrl: '/placeholders/products/skillet-placeholder.svg',
    images: [{ url: '/placeholders/products/skillet-placeholder.svg', alt: 'Ruffoni Opus Saucepan', isPrimary: true }],
    brand: BRANDS.ruffoni,
    category: CATEGORIES['saucepans'],
    materialSummary: 'Hammered copper with stainless lining',
    coatingSummary: 'None - bare stainless interior',
    verification: { tier: 4 as VerificationTier, claimType: 'inherently_pfas_free', scopeText: 'All copper and stainless cookware', rationale: 'Copper and stainless steel are inherently PFAS-free.', unknowns: [], hasEvidence: true, evidenceCount: 4, decisionDate: '2026-02-16' },
    components: [{ id: 'body', role: 'body', roleLabel: 'Pan Body', material: { id: 'copper', name: 'Hammered Copper', slug: 'copper' }, pfasStatus: 'verified_free' }],
    retailers: [{ id: 'ruffoni-sauce-amazon', retailer: RETAILERS.amazon, url: generateAmazonLink('B00461GRQM'), price: 450, currency: 'USD', inStock: true }],
    features: { inductionCompatible: false, ovenSafeTempF: 450, dishwasherSafe: false },
  },

  // ============================================================
  // PREMIUM DUTCH OVENS (HEIRLOOM QUALITY)
  // ============================================================

  {
    id: 'lecreuset-dutch-oven-7qt',
    name: 'Le Creuset Signature Round Dutch Oven 7.25 Qt',
    slug: 'lecreuset-dutch-oven-7qt',
    description: 'The gold standard in enameled cast iron. Ideal size for families. Made in France since 1925. Lifetime warranty. Interior enamel is PFAS and lead-free.',
    imageUrl: '/placeholders/products/dutch-oven-placeholder.svg',
    images: [{ url: '/placeholders/products/dutch-oven-placeholder.svg', alt: 'Le Creuset Dutch Oven 7.25 Qt', isPrimary: true }],
    brand: BRANDS.lecreuset,
    category: CATEGORIES['dutch-ovens'],
    materialSummary: 'Enameled cast iron',
    coatingSummary: 'Sand-colored enamel interior',
    verification: { tier: 4 as VerificationTier, claimType: 'inherently_pfas_free', scopeText: 'All Le Creuset enameled cast iron', rationale: 'Enamel is glass-based and inherently PFAS-free. Made in France since 1925.', unknowns: [], hasEvidence: true, evidenceCount: 5, decisionDate: '2026-02-16' },
    components: [{ id: 'body', role: 'body', roleLabel: 'Pot Body', material: { id: 'cast-iron', name: 'Enameled Cast Iron', slug: 'cast-iron' }, coating: { id: 'enamel', name: 'Enamel', slug: 'enamel' }, pfasStatus: 'verified_free' }],
    retailers: [{ id: 'lecreuset-7qt-amazon', retailer: RETAILERS.amazon, url: generateAmazonLink('B002VRHU7Q'), price: 480, currency: 'USD', inStock: true }],
    features: { inductionCompatible: true, ovenSafeTempF: 500, dishwasherSafe: true },
  },

  {
    id: 'staub-cocotte-round-7qt',
    name: 'Staub Cast Iron 7 Qt Round Cocotte',
    slug: 'staub-cocotte-round-7qt',
    description: 'Professional chef favorite. Self-basting lid with spikes for continuous moisture circulation. Matte black enamel interior develops better browning. Made in France.',
    imageUrl: '/placeholders/products/dutch-oven-placeholder.svg',
    images: [{ url: '/placeholders/products/dutch-oven-placeholder.svg', alt: 'Staub 7 Qt Cocotte', isPrimary: true }],
    brand: BRANDS.staub,
    category: CATEGORIES['dutch-ovens'],
    materialSummary: 'Enameled cast iron',
    coatingSummary: 'Matte black enamel interior',
    verification: { tier: 4 as VerificationTier, claimType: 'inherently_pfas_free', scopeText: 'All Staub enameled cast iron', rationale: 'Enamel is glass-based and inherently PFAS-free. Made in France.', unknowns: [], hasEvidence: true, evidenceCount: 5, decisionDate: '2026-02-16' },
    components: [{ id: 'body', role: 'body', roleLabel: 'Pot Body', material: { id: 'cast-iron', name: 'Enameled Cast Iron', slug: 'cast-iron' }, coating: { id: 'enamel', name: 'Enamel', slug: 'enamel' }, pfasStatus: 'verified_free' }],
    retailers: [{ id: 'staub-7qt-amazon', retailer: RETAILERS.amazon, url: generateAmazonLink('B003DGIZX6'), price: 450, currency: 'USD', inStock: true }],
    features: { inductionCompatible: true, ovenSafeTempF: 500, dishwasherSafe: true },
  },
  ...
  {
    id: 'emilehenry-bread-cloche',
    name: 'Emile Henry Ceramic Bread Cloche',
    slug: 'emilehenry-bread-cloche',
    description: 'French ceramic bread baker that recreates wood-fired oven conditions. Traps steam for perfect artisan crust. HR ceramic withstands thermal shock. Made in France since 1850.',
    imageUrl: '/placeholders/products/baking-dish-placeholder.svg',
    images: [{ url: '/placeholders/products/baking-dish-placeholder.svg', alt: 'Emile Henry Bread Cloche', isPrimary: true }],
    brand: BRANDS.emilehenry,
    category: CATEGORIES['baking-dishes'],
    materialSummary: 'HR (High Resistance) ceramic',
    coatingSummary: 'None - glazed ceramic',
    verification: { tier: 4 as VerificationTier, claimType: 'inherently_pfas_free', scopeText: 'All ceramic products', rationale: 'Glazed ceramic is inherently PFAS-free. Lead, cadmium, and nickel-free certified.', unknowns: [], hasEvidence: true, evidenceCount: 4, decisionDate: '2026-02-16' },
    components: [{ id: 'body', role: 'body', roleLabel: 'Cloche', material: { id: 'ceramic', name: 'HR Ceramic', slug: 'ceramic' }, pfasStatus: 'verified_free' }],
    retailers: [{ id: 'emilehenry-cloche-amazon', retailer: RETAILERS.amazon, url: generateAmazonLink('B00KQFWYJE'), price: 90, currency: 'USD', inStock: true }],
    features: { ovenSafeTempF: 520, dishwasherSafe: true },
  },

  {
    id: 'johnboos-endgrain-block-24',
    name: 'John Boos End Grain Maple Butcher Block 24" x 18"',
    slug: 'johnboos-endgrain-block-24',
    description: 'Premium end-grain construction for superior durability and knife preservation. Made in USA from sustainably sourced North American hard rock maple. The choice of professional chefs for 130+ years.',
    imageUrl: '/placeholders/products/cutting-board-placeholder.svg',
    images: [{ url: '/placeholders/products/cutting-board-placeholder.svg', alt: 'John Boos End Grain Block', isPrimary: true }],
    brand: BRANDS.johnboos,
    category: CATEGORIES['cutting-boards'],
    materialSummary: 'End-grain hard rock maple',
    coatingSummary: 'Food-safe natural oil finish',
    verification: { tier: 4 as VerificationTier, claimType: 'inherently_pfas_free', scopeText: 'All wood products', rationale: 'Natural maple wood is inherently PFAS-free. Made in USA since 1887.', unknowns: [], hasEvidence: true, evidenceCount: 3, decisionDate: '2026-02-16' },
    components: [{ id: 'body', role: 'body', roleLabel: 'Block', material: { id: 'maple-wood', name: 'Hard Rock Maple', slug: 'maple-wood' }, pfasStatus: 'verified_free' }],
    retailers: [{ id: 'johnboos-endgrain-amazon', retailer: RETAILERS.amazon, url: generateAmazonLink('B001DNCNGG'), price: 454, currency: 'USD', inStock: true }],
    features: { dishwasherSafe: false },
  },

  {
    id: 'johnboos-rboard-24',
    name: 'John Boos R-Board Edge Grain Cutting Board 24" x 18"',
    slug: 'johnboos-rboard-24',
    description: 'Professional-grade edge-grain maple cutting board. Reversible with finger grips. Made in USA from sustainable North American maple.',
    imageUrl: '/placeholders/products/cutting-board-placeholder.svg',
    images: [{ url: '/placeholders/products/cutting-board-placeholder.svg', alt: 'John Boos R-Board', isPrimary: true }],
    brand: BRANDS.johnboos,
    category: CATEGORIES['cutting-boards'],
    materialSummary: 'Edge-grain hard rock maple',
    coatingSummary: 'Food-safe natural oil finish',
    verification: { tier: 4 as VerificationTier, claimType: 'inherently_pfas_free', scopeText: 'All wood products', rationale: 'Natural maple wood is inherently PFAS-free.', unknowns: [], hasEvidence: true, evidenceCount: 3, decisionDate: '2026-02-16' },
    components: [{ id: 'body', role: 'body', roleLabel: 'Board', material: { id: 'maple-wood', name: 'Hard Rock Maple', slug: 'maple-wood' }, pfasStatus: 'verified_free' }],
    retailers: [{ id: 'johnboos-rboard-amazon', retailer: RETAILERS.amazon, url: generateAmazonLink('B00063QBK4'), price: 155, currency: 'USD', inStock: true }],
    features: { dishwasherSafe: false },
  },
  ...
  {
    id: 'caraway-food-storage-set',
    name: 'Caraway Glass Food Storage Set 14-Piece',
    slug: 'caraway-food-storage-set',
    description: 'Premium borosilicate glass containers with ceramic-coated steel lids. Includes magnetic storage organizer. BPA-free silicone seals. Oven and freezer safe.',
    imageUrl: '/placeholders/products/container-placeholder.svg',
    images: [{ url: '/placeholders/products/container-placeholder.svg', alt: 'Caraway Food Storage Set', isPrimary: true }],
    brand: BRANDS.caraway,
    category: CATEGORIES['glass-containers'],
    materialSummary: 'Borosilicate glass with steel lids',
    coatingSummary: 'None - bare glass',
    verification: { tier: 4 as VerificationTier, claimType: 'inherently_pfas_free', scopeText: 'All glass products', rationale: 'Glass is inherently PFAS-free. BPA-free certified.', unknowns: [], hasEvidence: true, evidenceCount: 3, decisionDate: '2026-02-16' },
    components: [{ id: 'body', role: 'body', roleLabel: 'Containers', material: { id: 'glass', name: 'Borosilicate Glass', slug: 'glass' }, pfasStatus: 'verified_free' }],
    retailers: [{ id: 'caraway-storage-amazon', retailer: RETAILERS.amazon, url: generateAmazonLink('B0BY8G5M1R'), price: 265, currency: 'USD', inStock: true }],
    features: { ovenSafeTempF: 450, dishwasherSafe: true },
  },

  {
    id: 'planetbox-rover-lunchbox',
    name: 'PlanetBox Rover Stainless Steel Lunch Box',
    slug: 'planetbox-rover-lunchbox',
    description: '100% stainless steel with 5 compartments. No plastic anywhere - even the latches are metal. Built to last a lifetime. 5-year warranty. Made for the eco-conscious family.',
    imageUrl: '/placeholders/products/container-placeholder.svg',
    images: [{ url: '/placeholders/products/container-placeholder.svg', alt: 'PlanetBox Rover', isPrimary: true }],
    brand: BRANDS.planetbox,
    category: CATEGORIES['stainless-containers'],
    materialSummary: '100% stainless steel',
    coatingSummary: 'None - bare stainless',
    verification: { tier: 4 as VerificationTier, claimType: 'inherently_pfas_free', scopeText: 'All stainless steel products', rationale: 'Stainless steel is inherently PFAS-free. Zero plastic construction.', unknowns: [], hasEvidence: true, evidenceCount: 3, decisionDate: '2026-02-16' },
    components: [{ id: 'body', role: 'body', roleLabel: 'Lunch Box', material: { id: 'stainless-steel', name: 'Stainless Steel', slug: 'stainless-steel' }, pfasStatus: 'verified_free' }],
    retailers: [{ id: 'planetbox-rover-amazon', retailer: RETAILERS.amazon, url: generateAmazonLink('B002RKG3TI'), price: 60, currency: 'USD', inStock: true }],
    features: { dishwasherSafe: true },
  },

  {
    id: 'weck-canning-jar-set',
    name: 'Weck Tulip Canning Jar Set (6 Pack)',
    slug: 'weck-canning-jar-set',
    description: 'German-made glass canning jars with glass lids. No plastic or metal touching food. Perfect for meal prep, fermentation, and canning. Reusable rubber seals.',
    imageUrl: '/placeholders/products/container-placeholder.svg',
    images: [{ url: '/placeholders/products/container-placeholder.svg', alt: 'Weck Tulip Jars', isPrimary: true }],
    brand: BRANDS.weck,
    category: CATEGORIES['glass-containers'],
    materialSummary: 'German glass with glass lids',
    coatingSummary: 'None - bare glass',
    verification: { tier: 4 as VerificationTier, claimType: 'inherently_pfas_free', scopeText: 'All glass products', rationale: 'Glass is inherently PFAS-free. Made in Germany.', unknowns: [], hasEvidence: true, evidenceCount: 3, decisionDate: '2026-02-16' },
    components: [{ id: 'body', role: 'body', roleLabel: 'Jars', material: { id: 'glass', name: 'German Glass', slug: 'glass' }, pfasStatus: 'verified_free' }],
    retailers: [{ id: 'weck-tulip-amazon', retailer: RETAILERS.amazon, url: generateAmazonLink('B00C3LNM0G'), price: 45, currency: 'USD', inStock: true }],
    features: { ovenSafeTempF: 350, dishwasherSafe: true },
  },
  ...
  {
    id: 'ankarsrum-stand-mixer',
    name: 'Ankarsrum Assistent Original Stand Mixer',
    slug: 'ankarsrum-stand-mixer',
    description: 'Swedish-made luxury stand mixer with unique bowl-spinning action. 7.4 Qt capacity handles nearly twice the dough of standard mixers. The choice of serious bread bakers. 7-year warranty.',
    imageUrl: '/placeholders/products/appliance-placeholder.svg',
    images: [{ url: '/placeholders/products/appliance-placeholder.svg', alt: 'Ankarsrum Stand Mixer', isPrimary: true }],
    brand: BRANDS.ankarsrum,
    category: CATEGORIES['stand-mixers'],
    materialSummary: 'Stainless steel bowl, die-cast housing',
    coatingSummary: 'None - bare stainless bowl',
    verification: { tier: 4 as VerificationTier, claimType: 'inherently_pfas_free', scopeText: 'Stainless steel components', rationale: 'Stainless steel bowl is inherently PFAS-free. All food-contact surfaces are metal or glass.', unknowns: [], hasEvidence: true, evidenceCount: 3, decisionDate: '2026-02-16' },
    components: [{ id: 'bowl', role: 'body', roleLabel: 'Bowl', material: { id: 'stainless-steel', name: 'Stainless Steel', slug: 'stainless-steel' }, pfasStatus: 'verified_free' }],
    retailers: [{ id: 'ankarsrum-amazon', retailer: RETAILERS.amazon, url: generateAmazonLink('B07R1RQFLS'), price: 799, currency: 'USD', inStock: true }],
    features: { dishwasherSafe: true },
  },

  {
    id: 'kitchenaid-pro-600',
    name: 'KitchenAid Pro 600 Series 6 Qt Stand Mixer',
    slug: 'kitchenaid-pro-600',
    description: 'Professional-grade stand mixer with bowl-lift design and 575-watt motor. Handles heavy bread doughs effortlessly. Stainless steel bowl. Made in USA.',
    imageUrl: '/placeholders/products/appliance-placeholder.svg',
    images: [{ url: '/placeholders/products/appliance-placeholder.svg', alt: 'KitchenAid Pro 600', isPrimary: true }],
    brand: BRANDS.kitchenaid,
    category: CATEGORIES['stand-mixers'],
    materialSummary: 'Die-cast metal with stainless bowl',
    coatingSummary: 'None - bare stainless bowl',
    verification: { tier: 4 as VerificationTier, claimType: 'inherently_pfas_free', scopeText: 'Stainless steel components', rationale: 'Stainless steel bowl is inherently PFAS-free. Made in USA.', unknowns: [], hasEvidence: true, evidenceCount: 3, decisionDate: '2026-02-16' },
    components: [{ id: 'bowl', role: 'body', roleLabel: 'Bowl', material: { id: 'stainless-steel', name: 'Stainless Steel', slug: 'stainless-steel' }, pfasStatus: 'verified_free' }],
    retailers: [{ id: 'kitchenaid-pro600-amazon', retailer: RETAILERS.amazon, url: generateAmazonLink('B00005UP2T'), price: 550, currency: 'USD', inStock: true }],
    features: { dishwasherSafe: true },
  },

  {
    ...
    description: 'Luxury automatic espresso with touchscreen interface. Dual boiler, integrated grinder, and automatic milk texturing. Stainless steel construction. The ultimate home barista experience.',
    imageUrl: '/placeholders/products/appliance-placeholder.svg',
    images: [{ url: '/placeholders/products/appliance-placeholder.svg', alt: 'Breville Oracle Touch', isPrimary: true }],
    brand: BRANDS.breville,
    category: CATEGORIES['espresso-machines'],
    materialSummary: 'Stainless steel boilers and portafilter',
    coatingSummary: 'None on food-contact surfaces',
    verification: { tier: 3 as VerificationTier, claimType: 'inherently_pfas_free', scopeText: 'Metal food-contact surfaces', rationale: 'Stainless steel boilers and portafilter are inherently PFAS-free. BPA-free water tank.', unknowns: ['Plastic water reservoir'], hasEvidence: true, evidenceCount: 2, decisionDate: '2026-02-16' },
    components: [{ id: 'boiler', role: 'body', roleLabel: 'Boilers', material: { id: 'stainless-steel', name: 'Stainless Steel', slug: 'stainless-steel' }, pfasStatus: 'verified_free' }],
    retailers: [{ id: 'breville-oracle-amazon', retailer: RETAILERS.amazon, url: generateAmazonLink('B078RQVQF1'), price: 2800, currency: 'USD', inStock: true }],
    features: { dishwasherSafe: false },
  },

  {
    ...
    slug: 'fellow-stagg-ekg-pro',
    description: 'Premium pour-over kettle with precision temperature control. Stainless steel body with no plastic touching water. Bluetooth connectivity for recipe saving. The choice of specialty coffee enthusiasts.',
    imageUrl: '/placeholders/products/appliance-placeholder.svg',
    images: [{ url: '/placeholders/products/appliance-placeholder.svg', alt: 'Fellow Stagg EKG Pro', isPrimary: true }],
    brand: BRANDS.fellow,
    category: CATEGORIES['kettles'],
    materialSummary: '304 stainless steel body and lid',
    coatingSummary: 'None - bare stainless interior',
