...
const MATERIALS: Material[] = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.893 13.393l-1.135-1.135a2.252 2.252 0 01-.421-.585l-1.08-2.16a.414.414 0 00-.663-.107.827.827 0 01-.812.21l-1.273-.363a.89.89 0 00-.738 1.595l.587.39c.59.395.674 1.23.172 1.732l-.2.2c-.212.212-.33.498-.33.796v.41c0 .409-.11.809-.32 1.158l-1.315 2.191a2.11 2.11 0 01-1.81 1.025 1.055 1.055 0 01-1.055-1.055v-1.172c0-.92-.56-1.747-1.414-2.089l-.654-.261a2.25 2.25 0 01-1.384-2.46l.007-.042a2.25 2.25 0 01.29-.787l.09-.15a2.25 2.25 0 012.37-1.048l1.178.236a1.125 1.125 0 001.302-.795l.208-.73a1.125 1.125 0 00-.578-1.315l-.665-.332-.091.091a2.25 2.25 0 01-1.591.659h-.18c-.249 0-.487.1-.662.274a.931.931 0 01-1.458-1.137l1.279-2.132A1.125 1.125 0 018.864 2.853l.3.1a1.125 1.125 0 001.289-.58l.084-.17a1.125 1.125 0 011.514-.513" />
      </svg>
    ),
  },
  {
  ...
  return (
    <section className={styles.container}>
      <div className={styles.header}>
        ...
        <p className={styles.subtitle}>Find products made from materials you trust</p>
      </div>
      ...
      <div className={styles.grid}>
        {MATERIALS.map((material) => (
          <Link
            key={material.slug}
            href={`/cookware?material=${material.slug}`}
          ...
          >
            ...
            <div className={styles.content}>
              ...
              <span className={styles.count}>{material.productCount} products</span>
            </div>
            <svg 
