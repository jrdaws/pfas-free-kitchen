/**
 * Testimonials Pattern - Carousel
 * 
 * Sliding testimonial cards.
 * Best for: Social proof, multiple testimonials
 */
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto relative">
          ...
          <div className="text-center">
            <blockquote className="text-2xl md:text-3xl text-gray-800 dark:text-gray-200 leading-relaxed mb-8">
              "{testimonial.quote}"
            </blockquote>
