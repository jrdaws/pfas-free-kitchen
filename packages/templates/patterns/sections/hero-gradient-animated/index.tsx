/**
 * Hero Gradient Animated Section
 * 
 * Animated gradient background with modern aesthetic.
 */

import Link from "next/link";

export interface HeroGradientAnimatedProps {
  headline: string;
  subtext: string;
  cta: {
    text: string;
...
export default HeroGradientAnimated;
