...
const DEFAULT_FEATURES: Feature[] = [
  {
    ...
    description: "Built for performance with optimized builds and edge deployment.",
    icon: "⚡",
  },
  {
    title: "Fully Customizable",
    description: "Tailored to your needs with flexible configuration options.",
    icon: "🎨",
  },
  {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`grid grid-cols-1 ${gridCols[columns]} gap-6`}>
          {features.map((feature, index) => (
            <div
              key={index}
              className="p-6 bg-slate-800/50 border border-slate-700/50 rounded-2xl hover:border-orange-500/30 hover:bg-slate-800 transition-all group"
            >
              {/* Icon */}
