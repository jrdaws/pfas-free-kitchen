...
const PAYMENT_PROVIDERS: PaymentProvider[] = [
  {
    id: "stripe",
    name: "Stripe",
    description: "Industry-standard payments platform",
    features: ["One-time payments", "Subscriptions", "Invoicing", "Tax calculation"],
    pricingNote: "2.9% + 30¢ per transaction",
  ...
  },
  {
    id: "paddle",
    name: "Paddle",
    description: "Merchant of record - handles global taxes",
    features: ["Subscriptions", "Tax compliance", "Fraud protection", "Global payments"],
    pricingNote: "5% + 50¢ per transaction (includes taxes)",
    docsUrl: "https://developer.paddle.com",
    signupUrl: "https://paddle.com/signup",
    difficulty: "Easy",
  },
  {
    id: "lemonsqueezy",
    ...
    features: ["Digital products", "Subscriptions", "License keys", "Tax handling"],
    pricingNote: "5% + 50¢ per transaction",
    ...
    <div className="space-y-2">
      ...
      {!selectedProvider && (
        <p className="text-[9px] text-white/30 italic">
          Optional: Skip if you don&apos;t need payments
        </p>
      )}
    </div>
  );
