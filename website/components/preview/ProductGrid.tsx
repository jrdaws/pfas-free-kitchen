          ...
          {products.map((product, i) => (
            ...
            >
              ...
              <div className="aspect-square bg-gradient-to-br from-gray-800 to-gray-900 flex items-center justify-center relative overflow-hidden">
                ...
                <div 
                  className={cn(
                    "w-16 h-16 rounded-full bg-gradient-to-br from-orange-500/20 to-orange-400/20 flex items-center justify-center absolute",
                ...
                {product.category && (
                  <span className="absolute top-3 left-3 px-2 py-1 bg-orange-500/80 text-white text-xs rounded-md z-10">
                    {product.category}
                  </span>
                )}
              </div>
              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  {showAddToCart && (
                    <button className="px-3 py-1.5 bg-stone-50/5 hover:bg-orange-500 text-stone-400 hover:text-white rounded-lg text-sm transition-all">
                      Add to Cart
                    </button>
                  )}
                </div>
